...
const transferFeatures = [
  {
    ...
    description:
      'Our service process text in many ways to extract the most of it, from   trivial skills like CS tools  to implicit ones hidden by gramatical ambiguties. ',
    icon: GlobeAltIcon,
  },
  {
    id: 2,
    name: ' Skill linkage ',
    description:
      'SkillNer link recognised skills in the processed text to a normalised skill database updated consistently  , making it easy to analyse its output . ',
    icon: ScaleIcon,
  },
  {
    id: 3,
    name: 'Blazing fast',
    description:
      'Our algorithm is build with scale in mind , making it able to process thousand of sentences in minutes .',
